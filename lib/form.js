(function() {
  ...
  Form = (function(_super) {
    ...
    function Form() {
      ...
      this.el.live("submit", this.didSubmit);
    }
    ...
    Form.prototype.didSubmit = function(e) {
      ...
      if (this.delegate != null) this.delegate.didSubmit(this.object);
      return this.object;
    };
    ...
    Form.prototype.reset = function() {
      return this.el.find("input[type=text], textarea").val('');
    };
    ...
    Form.prototype.classes = function(field) {
      return "" + field + " " + this.types[field];
    };
